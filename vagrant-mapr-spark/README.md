# MapR & Spark Vagrant Box
MapR v5.1.0 and Spark v1.5.2 vagrant box including MapR FileSystem, MapR-DB and MapR Streams. This box is based on  [`puppetlabs/centos-6.6-64-nocm` box](https://atlas.hashicorp.com/puppetlabs/boxes/centos-6.6-64-nocm) and uses virtualbox as a provider.
...
Start the MapR box:
```
vagrant init mkieboom/mapr-spark
vagrant up
```
