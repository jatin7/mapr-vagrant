...
MapR v5.0.0 and Spark v1.5.2 vagrant box including MapR Fileystem and MapR-DB. This box is based on  [`puppetlabs/centos-6.6-64-nocm` box](https://atlas.hashicorp.com/puppetlabs/boxes/centos-6.6-64-nocm) and uses virtualbox as a provider.
